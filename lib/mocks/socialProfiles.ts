...
export const INSTAGRAM_PROFILE = {
  ...
  posts: [
    { id: '1', imageUrl: 'https://picsum.photos/seed/felore_ig1/400/400', caption: '비즈니스 네트워킹 행사 🤝 #networking #startup', timestamp: '2일 전' },
    { id: '2', imageUrl: 'https://picsum.photos/seed/felore_ig2/400/400', caption: '팀과 함께한 하루 💪 #team #buildinginpublic', timestamp: '4일 전' },
    { id: '3', imageUrl: 'https://picsum.photos/seed/felore_ig3/400/400', caption: 'Growth hacking 세션 📈 #growth #marketing', timestamp: '1주 전' },
    { id: '4', imageUrl: 'https://picsum.photos/seed/felore_ig4/400/400', caption: '주말 골프 라운딩 ⛳ #golf #weekend', timestamp: '2주 전' },
    { id: '5', imageUrl: 'https://picsum.photos/seed/felore_ig5/400/400', caption: 'TEDx 준비 중 🎤 #tedx #speaking', timestamp: '3주 전' },
    { id: '6', imageUrl: 'https://picsum.photos/seed/felore_ig6/400/400', caption: '팀 회식 🍜 #team #dinner', timestamp: '1달 전' },
  ],
}
...
export const LINKEDIN_PROFILE = {
  ...
  headline: 'B2B SaaS Product Owner | 스타트업 공동창업자 | Felore',
  ...
  recentPosts: [
    ...
    { id: '2', text: 'Felore 개발 일지 #3 — 타인이 검증하고 채워주는 프로필 구조가 왜 더 신뢰를 만드는지에 대해...', likes: 203, date: '1주 전' },
  ],
}
