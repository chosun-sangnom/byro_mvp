...
export const problems: Array<{
  ...
  {
    icon: CreditCard,
    title: '그 사람이 어떤 사람인지 모릅니다',
    description: '이름과 회사만으로는 대화가 시작되지 않는다. 상대를 알 수 있는 정보가 어디에도 없다.',
  },
  {
    icon: Search,
    title: '첫인상만으로 신뢰를 쌓아야 합니다',
    description: '무슨 일을 해왔는지, 어떤 평판을 가진 사람인지. 만나기 전까지는 아무것도 확인할 수 없다.',
  },
  {
    icon: MessageCircle,
    title: '대화가 끝나도 연결이 안 됩니다',
    description: '겹치는 게 있어도 물어보기 전엔 모른다. 공통점을 찾을 때쯤이면 자리가 파한다.',
  },
]
