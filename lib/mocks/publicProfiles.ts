...
export const SAMPLE_PROFILE = {
  ...
  manualHighlights: [
    ...
    { id: 'mh3', categoryId: 'award', icon: 'trophy', title: 'K-Startup Excellence 2024', subtitle: '수상 · 자격증 · 직접 입력', description: '초기 스타트업 성장 전략 부문 우수 사례로 선정', year: '2024', metadata: { issuer: 'K-Startup' } },
  ] as Highlight[],
...
export const MK_PROFILE = {
  ...
  manualHighlights: [
    ...
    { id: 'mkh1', categoryId: 'talk', icon: 'book-open', title: '아이젠하워 펠로우십', subtitle: '강연 · 강의 · 교육 · 직접 입력', description: '전 세계 유망한 리더들을 선정해 미국 현지 연수와 교류 기회를 제공하는 리더십 프로그램에 선발되었습니다.', year: '2026' },
    { id: 'mkh2', categoryId: 'award', icon: 'trophy', title: '월드와이드 웹소설 공모전 · 우수상 수상', subtitle: '수상 · 자격증 · 직접 입력', description: '중앙일보 주최 공모전에서 <무진장>이라는 작품으로 우수상을 수상했습니다.', year: '2024' },
    { id: 'mkh3', categoryId: 'publish', icon: 'book-open', title: '당신의 엔진을 뜨겁게 달궈라', subtitle: '출판 · 기고 · 특허 · 직접 입력', description: '대학생들에게 열정 있는 삶을 권고하는 자기개발서입니다.', year: '2025' },
    {
      id: 'mkh4',
      categoryId: 'publish',
      icon: 'file-text',
      title: '강명구 코인원 부대표 "가상자산, 전통 금융 시장에 새 문법 제시"',
      subtitle: '출판 · 기고 · 특허 · 직접 입력',
...
export const BAEKHYUNJIN_PROFILE = {
  ...
  manualHighlights: [
    ...
    { id: 'bhj3', categoryId: 'talk', icon: 'mic', title: 'TEDxSeoul 2024 연사', subtitle: '강연 · 강의 · 교육 · 직접 입력', description: '디지털 전환 시대의 전략 프레임워크에 대해 발표했습니다.', year: '2024', metadata: {} },
    { id: 'bhj4', categoryId: 'award', icon: 'trophy', title: 'Global Strategy Award 2023', subtitle: '수상 · 자격증 · 직접 입력', description: 'APAC 최우수 전략 컨설팅 프로젝트 선정', year: '2023', metadata: {} },
  ] as Highlight[],
  kemi: {
    matchCount: 4,
    matchItems: [
