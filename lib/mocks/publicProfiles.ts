...
export const SAMPLE_PROFILE = {
  ...
  rememberHighlight: {
    total: 247,
    topCompany: { name: '삼성전자', count: 22 },
    topIndustry: { name: '스타트업', count: 94 },
    topRole: { name: '대표/임원', count: 58 },
  ...
  manualHighlights: [
    ...
    { id: 'mh3', categoryId: 'achievement', icon: 'trophy', title: 'K-Startup Excellence 2024', subtitle: '성과 · 직접 입력', description: '초기 스타트업 성장 전략 부문 우수 사례로 선정', year: '2024', metadata: { issuer: 'K-Startup' } },
  ] as Highlight[],
  ...
  guestbook: [
    ...
    { id: 'g5', linkId: 'parksojin', authorName: '박소진', message: '디테일을 챙기는 태도가 인상적이었어요.', date: '3주 전' },
    { id: 'g6', linkId: 'leejunhyuk', authorName: '이준혁', message: '어려운 문제도 침착하게 풀어가시더라고요.', date: '1개월 전' },
    { id: 'g7', linkId: 'choisunyoung', authorName: '최선영', message: '함께 일하고 싶은 파트너예요.', date: '1개월 전' },
    { id: 'g8', linkId: 'yoonjisoo', authorName: '윤지수', message: '커뮤니케이션이 명확해서 협업이 편했습니다.', date: '1개월 전' },
    { id: 'g9', linkId: 'kwonminseok', authorName: '권민석', message: '데이터 기반으로 설득력 있게 설명해주셨어요.', date: '2개월 전' },
    { id: 'g10', linkId: 'limjiyeon', authorName: '임지연', message: '약속한 일정을 항상 잘 지키는 분입니다.', date: '2개월 전' },
    { id: 'g11', linkId: 'hansanghoon', authorName: '한상훈', message: '글로벌 감각이 뛰어나고 배울 점이 많았어요.', date: '2개월 전' },
    { id: 'g12', linkId: 'ohyerim', authorName: '오예림', message: '아이디어를 실행으로 빠르게 옮기는 분이에요.', date: '3개월 전' },
  ],
...
export const MK_PROFILE = {
  ...
  rememberHighlight: {
    total: 1691,
    topCompany: { name: 'NAVER', count: 186 },
    topIndustry: { name: 'IT/테크', count: 286 },
    topRole: { name: '부장/이사', count: 402 },
  ...
  manualHighlights: [
    ...
    { id: 'mkh1', categoryId: 'activity', icon: 'book-open', title: '아이젠하워 펠로우십', subtitle: '활동 · 직접 입력', description: '전 세계 유망한 리더들을 선정해 미국 현지 연수와 교류 기회를 제공하는 리더십 프로그램에 선발되었습니다.', year: '2026' },
    { id: 'mkh2', categoryId: 'achievement', icon: 'trophy', title: '월드와이드 웹소설 공모전 · 우수상 수상', subtitle: '성과 · 직접 입력', description: '중앙일보 주최 공모전에서 <무진장>이라는 작품으로 우수상을 수상했습니다.', year: '2024' },
    { id: 'mkh3', categoryId: 'achievement', icon: 'book-open', title: '당신의 엔진을 뜨겁게 달궈라', subtitle: '성과 · 직접 입력', description: '대학생들에게 열정 있는 삶을 권고하는 자기개발서입니다.', year: '2025' },
    {
      id: 'mkh4',
      categoryId: 'activity',
      icon: 'file-text',
...
export const JIMIN_PROFILE = {
  ...
  rememberHighlight: {
    total: 183,
    topCompany: { name: '카카오', count: 24 },
    topIndustry: { name: '스타트업', count: 70 },
    topRole: { name: '대표/CEO', count: 41 },
...
export const PARKSOJIN_PROFILE = {
  ...
  rememberHighlight: {
    total: 312,
    topCompany: { name: '토스', count: 47 },
    topIndustry: { name: 'IT/테크', count: 125 },
    topRole: { name: '시니어/리드', count: 88 },
...
export const LEEJUNHYUK_PROFILE = {
  ...
  rememberHighlight: {
    total: 428,
    topCompany: { name: '쿠팡', count: 73 },
    topIndustry: { name: '스타트업', count: 193 },
    topRole: { name: 'CTO/VPE', count: 82 },
...
export const CHOISUNYOUNG_PROFILE = {
  ...
  rememberHighlight: {
    total: 589,
    topCompany: { name: '당근마켓', count: 53 },
    topIndustry: { name: '투자/VC', count: 247 },
    topRole: { name: '심사역/파트너', count: 56 },
...
export const YOONJISOO_PROFILE = {
  ...
  rememberHighlight: {
    total: 276,
    topCompany: { name: 'LG전자', count: 30 },
    topIndustry: { name: '마케팅/PR', count: 97 },
    topRole: { name: '디렉터/본부장', count: 33 },
...
export const KWONMINSEOK_PROFILE = {
  ...
  rememberHighlight: {
    total: 203,
    topCompany: { name: '우아한형제들', count: 26 },
    topIndustry: { name: 'IT/테크', count: 71 },
    topRole: { name: '시니어 엔지니어', count: 29 },
  ...
  manualHighlights: [
    ...
    { id: 'kms3', categoryId: 'achievement', icon: 'file-text', title: 'KDD 2023 논문 게재', subtitle: '성과 · 직접 입력', description: '개인화 추천 시스템 개선 관련 논문을 KDD 2023에 게재했습니다.', year: '2023', metadata: {} },
  ] as Highlight[],
  kemi: {
    matchCount: 3,
    matchItems: [
...
export const LIMJIYEON_PROFILE = {
  ...
  rememberHighlight: {
    total: 47,
    topCompany: { name: 'SK텔레콤', count: 7 },
    topIndustry: { name: '컨설팅', count: 14 },
    topRole: { name: '매니저', count: 11 },
...
export const HANSANGHOON_PROFILE = {
  ...
  rememberHighlight: {
    total: 534,
    topCompany: { name: '크래프톤', count: 91 },
    topIndustry: { name: 'IT/테크', count: 203 },
    topRole: { name: '매니저/디렉터', count: 124 },
...
export const OHYERIM_PROFILE = {
  ...
  rememberHighlight: {
    total: 138,
    topCompany: { name: '무신사', count: 12 },
    topIndustry: { name: '미디어/콘텐츠', count: 58 },
    topRole: { name: '프리랜서/독립', count: 17 },
...
export const JUNGWONHO_PROFILE = {
  ...
  rememberHighlight: {
    total: 364,
    topCompany: { name: '컬리', count: 40 },
    topIndustry: { name: '의료/바이오', count: 146 },
    topRole: { name: '교수/전문의', count: 53 },
...
export const BAEKHYUNJIN_PROFILE = {
  ...
  rememberHighlight: {
    total: 872,
    topCompany: { name: '넥슨', count: 113 },
    topIndustry: { name: '컨설팅', count: 305 },
    topRole: { name: '파트너/디렉터', count: 198 },
  ...
  manualHighlights: [
    ...
    { id: 'bhj3', categoryId: 'activity', icon: 'mic', title: 'TEDxSeoul 2024 연사', subtitle: '활동 · 직접 입력', description: '디지털 전환 시대의 전략 프레임워크에 대해 발표했습니다.', year: '2024', metadata: {} },
    { id: 'bhj4', categoryId: 'achievement', icon: 'trophy', title: 'Global Strategy Award 2023', subtitle: '성과 · 직접 입력', description: 'APAC 최우수 전략 컨설팅 프로젝트 선정', year: '2023', metadata: {} },
  ] as Highlight[],
  kemi: {
    matchCount: 4,
    matchItems: [
