...
export default function GuestbookScreen({ username }: { username: string }) {
  ...
  return (
    <div className="flex h-full flex-col" style={{ backgroundColor: 'var(--color-bg-page)' }}>
      <div className="flex items-center px-5 h-12 border-b flex-shrink-0" style={{ borderColor: 'var(--color-border-soft)', backgroundColor: 'var(--color-glass-mid)', backdropFilter: 'blur(12px)' }}>
