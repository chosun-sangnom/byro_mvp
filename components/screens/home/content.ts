...
export const problems: Array<{
  ...
  {
    icon: CreditCard,
    title: '만나고 나서도 그 사람을 모릅니다',
    description: '명함을 받아도, 링크드인을 찾아봐도 알 수 없다. 어떤 사람인지 파악하려면 다시 만나야 한다.',
  },
  {
    icon: Search,
    title: '신뢰는 시간이 지나야 생깁니다',
    description: '처음 만나는 자리에서 검증할 수 있는 건 아무것도 없다. 믿어도 되는 사람인지, 일단 부딪혀봐야 안다.',
  },
  {
    icon: MessageCircle,
    title: '공통점은 물어봐야만 알 수 있습니다',
    description: '같은 취향, 비슷한 경험이 있어도 꺼내기 전엔 모른다. 대화가 끊기고 나서야 겹치는 걸 발견한다.',
  },
]
