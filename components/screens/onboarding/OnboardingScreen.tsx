...
import { Step1Login, Step3LinkId } from '@/components/screens/onboarding/steps/OnboardingIntroSteps'
  ...
  return (
    <div className="flex flex-col h-full">
      <NavBar
        ...
        onClose={stepNum < 2 ? handleClose : undefined}
      />

      {stepNum >= 1 && stepNum <= 1 && (
        <StepBar current={stepNum} total={1} />
      )}
